...
interface ToastsParams {
    successToast: string,
    setSuccessToast: (msg: string) => void,
    failToast: string,
    setFailToast: (msg: string) => void
}

export default function Toasts({successToast, setSuccessToast, failToast, setFailToast}: ToastsParams) {
    return (
